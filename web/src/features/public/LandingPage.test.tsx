...
describe('LandingPage', () => {
  ...
  it('keeps the page readable when artwork and screenshots fail to load', () => {
    ...
    const shot = screen.getByRole('img', { name: /Monitor workspace/ })
    fireEvent.error(shot)
    expect(screen.queryByRole('img', { name: /Monitor workspace/ })).not.toBeInTheDocument()
  ...
  it('shows the three steps and the organizer workspace with real, layered artwork', () => {
    ...
    expect(screen.getByRole('img', { name: /Monitor workspace/ })).toHaveAttribute('src', '/landing/illustrated/workspace-preview.webp')
