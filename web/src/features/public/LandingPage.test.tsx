...
describe('LandingPage', () => {
  ...
  it('shows the three steps and the organizer workspace with real, layered artwork', () => {
    ...
    expect(screen.getByRole('img', { name: /kneeling over a map/ })).toHaveAttribute('src', '/landing/illustrated/step-plan.webp')
    expect(screen.getByRole('img', { name: /Two scouts walking/ })).toHaveAttribute('src', '/landing/illustrated/step-explore.webp')
  ...
  it('switches the personal plan between yearly and monthly', () => {
    mount()
