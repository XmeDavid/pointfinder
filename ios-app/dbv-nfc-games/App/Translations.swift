...
enum Translations {
    ...
    static let en: [String: String] = [
        ...
        "solve.processingMedia": "Processing media\u{2026}",
        ...
        "settings.deleteAccountConfirmMessage": "This will permanently delete your account. You must delete all your games first. This cannot be undone.",
        ...
        "operator.personalWorkspace": "Personal",
        "operator.gamesCount": "%d games",
        "operator.membersCount": "%d members",
        ...
        "setup.spatialPlan": "Spatial plan",
        "setup.spatialPlanDescription": "Place and inspect field stations on the live map.",
        "setup.openMap": "Open setup map",
        "setup.basesCount": "%d bases",
        "setup.nfcCount": "%d/%d NFC",
        "setup.assignmentsCount": "%d assignments",
        "setup.launchReadiness": "Launch readiness",
        "setup.readyCount": "%d of %d checks ready",
        "setup.configure": "Configure",
        "setup.fieldPlan": "Field plan",
        "setup.nfc": "NFC tags",
        "setup.nfcReady": "All NFC tags are linked",
        "setup.challengesReady": "%d challenges ready",
        "setup.teamsReady": "%d teams configured",
        "setup.teamVariables": "Team variables",
        "setup.teamVariablesReady": "All required team values are complete",
        "setup.stages": "Stages",
        ...
        "operator.assignments": "Assignments",
        "operator.unassigned": "Unassigned",
        "operator.newAssignment": "New Assignment",
        "operator.assign": "Assign",
        "operator.selectBase": "Select Base",
        "operator.selectChallenge": "Select Challenge",
        "operator.selectTeam": "Select Team",
        "operator.noAssignmentsDesc": "No assignments yet. Tap + to create one.",
        "operator.basesWithNoAssignments": "Bases Without Assignments",
        "operator.assignmentLockedAllTeams": "All-teams assignment already exists for this base.",
        "operator.deleteAssignmentTitle": "Delete Assignment?",
        "operator.deleteAssignmentMessage": "This assignment will be permanently removed.",
        ...
        "operator.visibleBase": "Visible base",
        "operator.none": "None",
        "operator.save": "Save",
        ...
        "editor.insertingImage": "Inserting image…",
        "editor.imageNotDownloaded": "This photo is stored in iCloud. Please download it first, then try again.",
        "editor.imageLoadFailed": "Could not load the selected image. Try a different photo.",
        ...
        "operator.valuesComplete": "Values",
        ...
        "operator.activity.title": "Activity",
        "operator.activity.empty": "No activity yet",
        "operator.activity.error": "Couldn't load activity. Pull to refresh.",
        "operator.activity.loadMore": "Load more",
        "operator.activity.filterAll": "All actions",
        "operator.activity.filterMarkCompleted": "Mark completed",
        "operator.activity.filterManualCheckIn": "Manual check-in",
        "operator.activity.filterUnlockOverride": "Unlock override",
        "operator.activity.filterReview": "Submission review",
        ...
        "operator.undefinedVariables": "Undefined variables",
        "operator.undefinedVariablesMessage": "The following variables are referenced but not defined: %@",
        "operator.autocomplete.createVariable": "Create variable",
        "operator.autocomplete.noMatches": "No matches",
        "operator.saveAnyway": "Save anyway",
        ...
        "operator.noChallengesAssigned": "No challenges assigned",
        ...
        "tags.noBasesFiltered": "No bases match the selected filters.",
        "tags.noChallengesFiltered": "No challenges match the selected filters.",
        ...
        // Organization
        "org.members": "Members",
        "org.liveGames": "Live Games",
        "org.inviteMember": "Invite Member",
        "org.inviteByEmail": "Invite by Email",
        "org.emailAddress": "Email address",
        "org.noMembers": "No members yet.",
        "org.removeMember": "Remove Member",
        "org.removeMemberMessage": "Remove %@ from %@?",
        "org.loadingMembers": "Loading members\u{2026}",
        "org.noPermissions": "No permissions",
        "org.permOperateGames": "Operate",
        "org.permCreateGames": "Create",
        "org.permDeleteGames": "Delete",
        "org.permInviteMembers": "Invite",
        "org.permManagePerms": "Perms",
        "org.permManageBilling": "Billing",
        "org.permOperateGamesFull": "Operate Games",
        "org.permCreateGamesFull": "Create Games",
        "org.permDeleteGamesFull": "Delete Games",
        "org.permInviteMembersFull": "Invite Members",
        "org.permManagePermsFull": "Manage Permissions",
        "org.permManageBillingFull": "Manage Billing",
        "org.editPermissions": "Edit Permissions",
        "org.permissionsFor": "Permissions for %@",
        "org.inviteSentTo": "Invite sent to %@",
        "org.send": "Send",
        "org.remove": "Remove",

        // Stages
        "stages.noStages": "No Stages",
        "stages.noStagesDesc": "Create stages to gate base visibility during the game.",
        "stages.title": "Stages",
        "stages.scheduled": "Scheduled",
        "stages.trigger": "Trigger",
        "stages.manual": "Manual",
        "stages.active": "Active",
        "stages.inactive": "Inactive",
        "stages.oneBase": "1 base",
        "stages.nBases": "%d bases",
        "stages.details": "Details",
        "stages.name": "Name",
        "stages.descriptionOptional": "Description (optional)",
        "stages.transition": "Transition",
        "stages.activateAt": "Activate At",
        "stages.triggerBase": "Trigger Base",
        "stages.none": "None",
        "stages.assignedBases": "Assigned Bases",
        "stages.noBasesAssigned": "No bases assigned to this stage yet. Assign bases via the Base editor.",
        "stages.deleteStage": "Delete Stage",
        "stages.newStage": "New Stage",
        "stages.deleteAlertTitle": "Delete Stage",
        "stages.deleteAlertMessage": "Are you sure you want to delete \"%@\"? This cannot be undone.",
        "stages.stageNofM": "Stage %d of %d",
        "stages.noActiveStage": "No active stage",
        "stages.nConfigured": "%d stage(s) configured",
        "stages.manage": "Manage \u{2192}",

        // Invites (MyInvitesView)
        "invites.noPending": "No Pending Invitations",
        "invites.noPendingDesc": "You have no pending game invitations.",
        "invites.invitedYouTo": "%@ invited you to %@",
    ...
    static let pt: [String: String] = [
        ...
        "common.pts": "pts",
        "common.allTeams": "Todas as Equipas",
        "common.checkIn": "Check-in",
        ...
        "solve.processingMedia": "A processar m\u{00E9}dia\u{2026}",
        ...
        "solve.photoHelp": "As tuas fotos serão revistas por um operador.",
        ...
        "settings.deleteAccountConfirmMessage": "Isto irá eliminar permanentemente a tua conta. Deves eliminar todos os teus jogos primeiro. Esta ação não pode ser desfeita.",
        ...
        "operator.personalWorkspace": "Pessoal",
        "operator.gamesCount": "%d jogos",
        "operator.membersCount": "%d membros",
        ...
        "setup.spatialPlan": "Plano espacial",
        "setup.spatialPlanDescription": "Coloca e inspeciona as bases no mapa em tempo real.",
        "setup.openMap": "Abrir mapa de configuração",
        "setup.basesCount": "%d bases",
        "setup.nfcCount": "%d/%d NFC",
        "setup.assignmentsCount": "%d atribuições",
        "setup.launchReadiness": "Prontidão para iniciar",
        "setup.readyCount": "%d de %d verificações prontas",
        "setup.configure": "Configurar",
        "setup.fieldPlan": "Plano de campo",
        "setup.nfc": "Etiquetas NFC",
        "setup.nfcReady": "Todas as etiquetas NFC estão associadas",
        "setup.challengesReady": "%d desafios prontos",
        "setup.teamsReady": "%d equipas configuradas",
        "setup.teamVariables": "Variáveis das equipas",
        "setup.teamVariablesReady": "Todos os valores obrigatórios estão completos",
        "setup.stages": "Etapas",
        ...
        "operator.assignments": "Atribui\u{00E7}\u{00F5}es",
        "operator.unassigned": "Sem atribui\u{00E7}\u{00E3}o",
        "operator.newAssignment": "Nova Atribui\u{00E7}\u{00E3}o",
        "operator.assign": "Atribuir",
        "operator.selectBase": "Selecionar Base",
        "operator.selectChallenge": "Selecionar Desafio",
        "operator.selectTeam": "Selecionar Equipa",
        "operator.noAssignmentsDesc": "Sem atribui\u{00E7}\u{00F5}es ainda. Toque em + para criar uma.",
        "operator.basesWithNoAssignments": "Bases Sem Atribui\u{00E7}\u{00F5}es",
        "operator.assignmentLockedAllTeams": "J\u{00E1} existe uma atribui\u{00E7}\u{00E3}o para todas as equipas nesta base.",
        "operator.deleteAssignmentTitle": "Eliminar Atribui\u{00E7}\u{00E3}o?",
        "operator.deleteAssignmentMessage": "Esta atribui\u{00E7}\u{00E3}o ser\u{00E1} permanentemente removida.",
        ...
        "operator.visibleBase": "Base visível",
        ...
        "editor.insertingImage": "A inserir imagem\u{2026}",
        "editor.imageNotDownloaded": "Esta foto est\u{00E1} no iCloud. Descarregue-a primeiro e tente novamente.",
        "editor.imageLoadFailed": "N\u{00E3}o foi poss\u{00ED}vel carregar a imagem. Tente outra foto.",
        ...
        "operator.edit": "Editar",
        "operator.preview": "Pr\u{00E9}-visualizar",
        "operator.undefinedVariables": "Vari\u{00E1}veis indefinidas",
        "operator.undefinedVariablesMessage": "As seguintes vari\u{00E1}veis s\u{00E3}o referenciadas mas n\u{00E3}o definidas: %@",
        "operator.autocomplete.createVariable": "Criar vari\u{00E1}vel",
        "operator.autocomplete.noMatches": "Sem correspond\u{00EA}ncias",
        "operator.saveAnyway": "Guardar mesmo assim",
        ...
        "operator.noChallengesAssigned": "Sem desafios atribuídos",
        ...
        "operator.valuesComplete": "Valores",
        ...
        "operator.activity.title": "Atividade",
        "operator.activity.empty": "Sem atividade ainda",
        "operator.activity.error": "Não foi possível carregar a atividade. Puxa para atualizar.",
        "operator.activity.loadMore": "Carregar mais",
        "operator.activity.filterAll": "Todas as ações",
        "operator.activity.filterMarkCompleted": "Marcar como concluído",
        "operator.activity.filterManualCheckIn": "Check-in manual",
        "operator.activity.filterUnlockOverride": "Substituição de bloqueio",
        "operator.activity.filterReview": "Revisão de submissão",
        ...
        "tags.filterByTag": "Filtrar por etiqueta",
        "tags.clearFilters": "Limpar filtros",
        "tags.noBasesFiltered": "Nenhuma base corresponde aos filtros selecionados.",
        "tags.noChallengesFiltered": "Nenhum desafio corresponde aos filtros selecionados.",
        ...
        // Organization
        "org.members": "Membros",
        "org.liveGames": "Jogos em Direto",
        "org.inviteMember": "Convidar Membro",
        "org.inviteByEmail": "Convidar por Email",
        "org.emailAddress": "Endereço de email",
        "org.noMembers": "Ainda sem membros.",
        "org.removeMember": "Remover Membro",
        "org.removeMemberMessage": "Remover %@ de %@?",
        "org.loadingMembers": "A carregar membros\u{2026}",
        "org.noPermissions": "Sem permissões",
        "org.permOperateGames": "Operar",
        "org.permCreateGames": "Criar",
        "org.permDeleteGames": "Eliminar",
        "org.permInviteMembers": "Convidar",
        "org.permManagePerms": "Perms",
        "org.permManageBilling": "Faturação",
        "org.permOperateGamesFull": "Operar Jogos",
        "org.permCreateGamesFull": "Criar Jogos",
        "org.permDeleteGamesFull": "Eliminar Jogos",
        "org.permInviteMembersFull": "Convidar Membros",
        "org.permManagePermsFull": "Gerir Permissões",
        "org.permManageBillingFull": "Gerir Faturação",
        "org.editPermissions": "Editar Permissões",
        "org.permissionsFor": "Permissões de %@",
        "org.inviteSentTo": "Convite enviado para %@",
        "org.send": "Enviar",
        "org.remove": "Remover",

        // Stages
        "stages.noStages": "Sem Fases",
        "stages.noStagesDesc": "Cria fases para controlar a visibilidade das bases durante o jogo.",
        "stages.title": "Fases",
        "stages.scheduled": "Agendado",
        "stages.trigger": "Gatilho",
        "stages.manual": "Manual",
        "stages.active": "Ativa",
        "stages.inactive": "Inativa",
        "stages.oneBase": "1 base",
        "stages.nBases": "%d bases",
        "stages.details": "Detalhes",
        "stages.name": "Nome",
        "stages.descriptionOptional": "Descrição (opcional)",
        "stages.transition": "Transição",
        "stages.activateAt": "Ativar Em",
        "stages.triggerBase": "Base Gatilho",
        "stages.none": "Nenhuma",
        "stages.assignedBases": "Bases Atribuídas",
        "stages.noBasesAssigned": "Nenhuma base atribuída a esta fase ainda. Atribui bases através do editor de bases.",
        "stages.deleteStage": "Eliminar Fase",
        "stages.newStage": "Nova Fase",
        "stages.deleteAlertTitle": "Eliminar Fase",
        "stages.deleteAlertMessage": "Tens a certeza que queres eliminar \"%@\"? Esta ação não pode ser desfeita.",
        "stages.stageNofM": "Fase %d de %d",
        "stages.noActiveStage": "Sem fase ativa",
        "stages.nConfigured": "%d fase(s) configurada(s)",
        "stages.manage": "Gerir \u{2192}",

        // Invites (MyInvitesView)
        "invites.noPending": "Sem Convites Pendentes",
        "invites.noPendingDesc": "Não tens convites de jogo pendentes.",
        "invites.invitedYouTo": "%@ convidou-te para %@",
    ...
    static let de: [String: String] = [
        ...
        "solve.processingMedia": "Medien werden verarbeitet\u{2026}",
        ...
        "settings.deleteAccountConfirmMessage": "Dadurch wird dein Konto dauerhaft gelöscht. Du musst zuerst alle deine Spiele löschen. Dies kann nicht rückgängig gemacht werden.",
        ...
        "operator.personalWorkspace": "Persönlich",
        "operator.gamesCount": "%d Spiele",
        "operator.membersCount": "%d Mitglieder",
        ...
        "setup.spatialPlan": "Räumlicher Plan",
        "setup.spatialPlanDescription": "Stationen auf der Live-Karte platzieren und prüfen.",
        "setup.openMap": "Einrichtungskarte öffnen",
        "setup.basesCount": "%d Stationen",
        "setup.nfcCount": "%d/%d NFC",
        "setup.assignmentsCount": "%d Zuweisungen",
        "setup.launchReadiness": "Startbereitschaft",
        "setup.readyCount": "%d von %d Prüfungen bereit",
        "setup.configure": "Konfigurieren",
        "setup.fieldPlan": "Feldplan",
        "setup.nfc": "NFC-Tags",
        "setup.nfcReady": "Alle NFC-Tags sind verknüpft",
        "setup.challengesReady": "%d Challenges bereit",
        "setup.teamsReady": "%d Teams konfiguriert",
        "setup.teamVariables": "Teamvariablen",
        "setup.teamVariablesReady": "Alle erforderlichen Teamwerte sind vollständig",
        "setup.stages": "Phasen",
        ...
        "operator.assignments": "Zuweisungen",
        "operator.unassigned": "Nicht zugewiesen",
        "operator.newAssignment": "Neue Zuweisung",
        "operator.assign": "Zuweisen",
        "operator.selectBase": "Station ausw\u{00E4}hlen",
        "operator.selectChallenge": "Challenge ausw\u{00E4}hlen",
        "operator.selectTeam": "Team ausw\u{00E4}hlen",
        "operator.noAssignmentsDesc": "Noch keine Zuweisungen. Tippe auf + um eine zu erstellen.",
        "operator.basesWithNoAssignments": "Stationen ohne Zuweisungen",
        "operator.assignmentLockedAllTeams": "F\u{00FC}r diese Station existiert bereits eine Alle-Teams-Zuweisung.",
        "operator.deleteAssignmentTitle": "Zuweisung l\u{00F6}schen?",
        "operator.deleteAssignmentMessage": "Diese Zuweisung wird dauerhaft entfernt.",
        ...
        "operator.visibleBase": "Sichtbare Station",
        "operator.none": "Keine",
        ...
        "editor.insertingImage": "Bild wird eingef\u{00FC}gt\u{2026}",
        "editor.imageNotDownloaded": "Dieses Foto ist in iCloud gespeichert. Bitte zuerst herunterladen und erneut versuchen.",
        "editor.imageLoadFailed": "Das Bild konnte nicht geladen werden. Versuche ein anderes Foto.",
        ...
        "operator.edit": "Bearbeiten",
        "operator.preview": "Vorschau",
        "operator.undefinedVariables": "Nicht definierte Variablen",
        "operator.undefinedVariablesMessage": "Folgende Variablen werden verwendet, aber nicht definiert: %@",
        "operator.autocomplete.createVariable": "Variable erstellen",
        "operator.autocomplete.noMatches": "Keine Treffer",
        "operator.saveAnyway": "Trotzdem speichern",
        ...
        "operator.noChallengesAssigned": "Keine Challenges zugewiesen",
        ...
        "operator.activity.title": "Aktivität",
        "operator.activity.empty": "Noch keine Aktivität",
        "operator.activity.error": "Aktivität konnte nicht geladen werden. Zum Aktualisieren ziehen.",
        "operator.activity.loadMore": "Mehr laden",
        "operator.activity.filterAll": "Alle Aktionen",
        "operator.activity.filterMarkCompleted": "Als abgeschlossen markieren",
        "operator.activity.filterManualCheckIn": "Manueller Check-in",
        "operator.activity.filterUnlockOverride": "Sperraufhebung",
        "operator.activity.filterReview": "Einreichungsprüfung",
        ...
        "tags.filterByTag": "Nach Tag filtern",
        "tags.clearFilters": "Filter löschen",
        "tags.noBasesFiltered": "Keine Stationen entsprechen den ausgewählten Filtern.",
        "tags.noChallengesFiltered": "Keine Challenges entsprechen den ausgewählten Filtern.",
        ...
        "org.liveGames": "Aktive Spiele",
        "org.inviteMember": "Mitglied einladen",
        "org.inviteByEmail": "Per E-Mail einladen",
        "org.emailAddress": "E-Mail-Adresse",
        "org.noMembers": "Noch keine Mitglieder.",
        "org.removeMember": "Mitglied entfernen",
        "org.removeMemberMessage": "%@ aus %@ entfernen?",
        "org.loadingMembers": "Mitglieder werden geladen\u{2026}",
        "org.noPermissions": "Keine Berechtigungen",
        "org.permOperateGames": "Betreiben",
        "org.permCreateGames": "Erstellen",
        "org.permDeleteGames": "Löschen",
        "org.permInviteMembers": "Einladen",
        "org.permManagePerms": "Rechte",
        "org.permManageBilling": "Abrechnung",
        "org.permOperateGamesFull": "Spiele betreiben",
        "org.permCreateGamesFull": "Spiele erstellen",
        "org.permDeleteGamesFull": "Spiele löschen",
        "org.permInviteMembersFull": "Mitglieder einladen",
        "org.permManagePermsFull": "Berechtigungen verwalten",
        "org.permManageBillingFull": "Abrechnung verwalten",
        "org.editPermissions": "Berechtigungen bearbeiten",
        "org.permissionsFor": "Berechtigungen für %@",
        "org.inviteSentTo": "Einladung an %@ gesendet",
        "org.send": "Senden",
        "org.remove": "Entfernen",

        // Stages
        "stages.noStages": "Keine Phasen",
        "stages.noStagesDesc": "Erstelle Phasen, um die Sichtbarkeit der Stationen während des Spiels zu steuern.",
        "stages.title": "Phasen",
        "stages.scheduled": "Geplant",
        "stages.trigger": "Auslöser",
        "stages.manual": "Manuell",
        "stages.active": "Aktiv",
        "stages.inactive": "Inaktiv",
        "stages.oneBase": "1 Station",
        "stages.nBases": "%d Stationen",
        "stages.details": "Details",
        "stages.name": "Name",
        "stages.descriptionOptional": "Beschreibung (optional)",
        "stages.transition": "Übergang",
        "stages.activateAt": "Aktivieren um",
        "stages.triggerBase": "Auslöser-Station",
        "stages.none": "Keine",
        "stages.assignedBases": "Zugewiesene Stationen",
        "stages.noBasesAssigned": "Dieser Phase sind noch keine Stationen zugewiesen. Weise Stationen über den Stationseditor zu.",
        "stages.deleteStage": "Phase löschen",
        "stages.newStage": "Neue Phase",
        "stages.deleteAlertTitle": "Phase löschen",
        "stages.deleteAlertMessage": "Möchtest du \"%@\" wirklich löschen? Dies kann nicht rückgängig gemacht werden.",
        "stages.stageNofM": "Phase %d von %d",
        "stages.noActiveStage": "Keine aktive Phase",
        "stages.nConfigured": "%d Phase(n) konfiguriert",
        "stages.manage": "Verwalten \u{2192}",

        // Invites (MyInvitesView)
        "invites.noPending": "Keine ausstehenden Einladungen",
        "invites.noPendingDesc": "Du hast keine ausstehenden Spieleinladungen.",
        "invites.invitedYouTo": "%@ hat dich zu %@ eingeladen",
