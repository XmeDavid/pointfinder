...
enum Translations {
    ...
    static let en: [String: String] = [
        ...
        "operator.goLiveConfirmMessage": "Once live, teams can start playing. This cannot be undone.",
        ...
        "operator.endGameConfirmMessage": "This will end the game for all players.",
    ...
    static let pt: [String: String] = [
        ...
        "operator.goLiveConfirmMessage": "Depois de iniciado, as equipas podem começar a jogar. Não pode ser revertido.",
        ...
        "operator.endGameConfirmMessage": "Isto ir\u{00E1} terminar o jogo para todos os jogadores.",
    ...
    static let de: [String: String] = [
        ...
        "operator.goLiveConfirmMessage": "Sobald gestartet, können Teams spielen. Dies kann nicht rückgängig gemacht werden.",
        ...
        "operator.endGameConfirmMessage": "Dies beendet das Spiel f\u{00FC}r alle Spieler.",
