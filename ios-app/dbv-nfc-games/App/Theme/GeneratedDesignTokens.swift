...
enum PFColorToken {
    ...
    static let brandMark = Color.pfAdaptive(light: "#174a32", dark: "#eef4ef")
    static let brandTile = Color.pfAdaptive(light: "#174a32", dark: "#174a32")
    static let brandOnTile = Color.pfAdaptive(light: "#ffffff", dark: "#ffffff")
