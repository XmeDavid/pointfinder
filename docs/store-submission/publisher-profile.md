...
Use these values consistently across App Store Connect, Google Play Console, privacy policy, and in-app metadata.
...
| Field | Value |
|-------|-------|
| Privacy contact email | info@desbravadores.dev |
| Support contact email | info@desbravadores.dev |
| Website | https://desbravadores.dev |

## URLs (for store forms)

| Field | Value |
|-------|-------|
| Privacy Policy URL | https://desbravadores.dev/privacy/ |
| Account Deletion URL (Google Play) | https://desbravadores.dev/privacy/#deletion-request |
| Support URL (Apple) | https://desbravadores.dev |
