...
| Native welcome home (join / sign in) and the player map prompt after joining | pending | n/a | n/a |
...
| Stage routes: route editor with an exploratory and an ordered stage, setup and read-only | yes | n/a | n/a |
| Operator document viewer: read, edit, empty, offline, file | yes | n/a | n/a |
