...
| PF-08 | Explore | Signed-in featured/search/nearby/map/pagination and joining, admin curation, listing reports, moderation hold, report alerts and account blocking implemented | Listing artwork, area location, scalable queries and refresh (OW-06/07); persistent offerings need PF-06 |
