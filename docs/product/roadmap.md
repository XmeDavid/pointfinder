...
| PF-07 | Publication and admission | Opt-in listings, publisher controls and direct account admission to one existing team implemented | Team capacities, lobby, operator/automatic/player-choice placement (OW-05); visibility stays independent |
| PF-08 | Explore | Signed-in featured/search/nearby/map/pagination and joining implemented | Curation, moderation, area location, media, scalable queries and refresh (OW-06/07); persistent offerings need PF-06 |
...
| PF-10 | Activity files and documents | Game-scoped organizer authoring/sharing and player documents implemented | Organization resources for org games, realtime sharing refresh, deliberate offline-file policy (OW-08) |
