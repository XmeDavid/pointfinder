...
export function PinMarkerSvg({ color }: { color: string }) {
  return (
    <svg width="25" height="41" viewBox="0 0 25 41" xmlns="http://www.w3.org/2000/svg" style={{ display: "block" }}>
      <path d="M12.5 0C5.6 0 0 5.6 0 12.5C0 21.9 12.5 41 12.5 41S25 21.9 25 12.5C25 5.6 19.4 0 12.5 0Z" fill={color} stroke="var(--pf-dataColor-white)" strokeWidth="1.5"/>
      <circle cx="12.5" cy="12.5" r="5" fill="var(--pf-dataColor-white)"/>
    </svg>
  );
}
  ...
  return (
    <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} style={{ display: "block" }}>
      <circle
        ...
        stroke={stale ? "var(--pf-dataColor-statusNotVisited)" : color}
